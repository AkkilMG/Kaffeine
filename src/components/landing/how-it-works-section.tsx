    ...
    <section id="how-it-works" className="relative py-24 md:py-32 bg-muted/30">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-6 relative">
          ...
          <div className="hidden md:block absolute top-12 left-[calc(16.66%+1.5rem)] right-[calc(16.66%+1.5rem)] h-px bg-gradient-to-r from-primary/20 via-primary/40 to-primary/20 pointer-events-none" />
          ...
          {steps.map((step, i) => (
            ...
            >
              <div className="rounded-xl border border-border bg-card p-6 md:p-8 hover:border-primary/30 transition-all duration-500 h-full relative">
                  ...
                  <div className="relative shrink-0">
                    ...
                    {i < steps.length - 1 && (
                      <div className="hidden md:block absolute -right-8 top-1/2 -translate-y-1/2">
                        <ArrowDown size={16} className="text-primary/30 rotate-270" />
                      </div>
                    )}
                  </div>
